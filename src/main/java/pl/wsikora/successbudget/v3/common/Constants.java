...
public class Constants {
    ...
    public static final String PLANNED_EXPENDITURE_EDIT_PATH = PLANNED_EXPENDITURE_PATH + EDIT_PATH;
    public static final String PLANNED_EXPENDITURE_DELETE_PATH = PLANNED_EXPENDITURE_PATH + DELETE_PATH;
    ...
    public static final String EXPENDITURE_EDIT_PATH = EXPENDITURE_PATH + EDIT_PATH;
    public static final String EXPENDITURE_DELETE_PATH = EXPENDITURE_PATH + DELETE_PATH;
    ...
    public static final String REVENUE_EDIT_PATH = REVENUE_PATH + EDIT_PATH;
    public static final String REVENUE_DELETE_PATH = REVENUE_PATH + DELETE_PATH;
